...
class VisitTrackingService {
  ...
  final _visitStreamController = StreamController<List<ActiveVisit>>.broadcast();
  Stream<List<ActiveVisit>> get activeVisitsStream => _visitStreamController.stream;
  ...
  Future<void> handleVisit(String faceId, String cameraId, TrackedFace person) async {
    try {
